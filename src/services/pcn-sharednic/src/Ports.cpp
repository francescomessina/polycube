...
Ports::Ports(polycube::service::Cube<Ports> &parent,
  ...
  Port(port), parent_(static_cast<Sharednic&>(parent)) {
...
void Ports::create(Sharednic &parent, const std::string &name, const PortsJsonObject &conf){
...
std::shared_ptr<Ports> Ports::getEntry(Sharednic &parent, const std::string &name){
...
void Ports::removeEntry(Sharednic &parent, const std::string &name){
...
std::vector<std::shared_ptr<Ports>> Ports::get(Sharednic &parent){
  // This methods get the pointers to all the Ports objects in Sharednic.
  return parent.get_ports();
}

void Ports::remove(Sharednic &parent){
  // This method removes all Ports objects in Sharednic.
