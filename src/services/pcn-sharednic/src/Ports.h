...
class Ports : public polycube::service::Port, public PortsInterface {
 public:
  ...
  static void create(Sharednic &parent, const std::string &name, const PortsJsonObject &conf);
  static std::shared_ptr<Ports> getEntry(Sharednic &parent, const std::string &name);
  static void removeEntry(Sharednic &parent, const std::string &name);
  static std::vector<std::shared_ptr<Ports>> get(Sharednic &parent);
  static void remove(Sharednic &parent);
