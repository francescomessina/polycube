...
class  RouterApi : public ManagementInterface {
 ...
 protected:
  ...
  void read_router_ports_mirror_by_id_handler(const polycube::service::Rest::Request &request, polycube::service::HttpHandleResponse &response);
  ...
  void update_router_ports_mirror_by_id_handler(const polycube::service::Rest::Request &request, polycube::service::HttpHandleResponse &response);
  ...
  /// <param name="name">ID of name</param>
  /// <param name="portsName">ID of ports_name</param>
  virtual std::string read_router_ports_mirror_by_id(const std::string &name, const std::string &portsName) = 0;
  /// <summary>
  /// Read netmask by ID
  /// </summary>
  /// <remarks>
  ...
  /// <param name="name">ID of name</param>
  /// <param name="portsName">ID of ports_name</param>
  /// <param name="value">Name of the mirror interface</param>
  virtual void update_router_ports_mirror_by_id(const std::string &name, const std::string &portsName, const std::string &value) = 0;
  /// <summary>
