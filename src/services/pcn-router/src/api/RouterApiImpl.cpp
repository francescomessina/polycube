...
*/
bool
read_router_span_by_id(const std::string &name) {
  auto router = get_cube(name);
  return router->getSpan();

}

/**
* @brief   Update span by ID
*
* Update operation of resource: span*
*
* @param[in] name ID of name
* @param[in] value Defines if all traffic is sent to Linux
*
* Responses:
*
*/
void
update_router_span_by_id(const std::string &name, const bool &value) {
  auto router = get_cube(name);

  router->setSpan(value);
}
