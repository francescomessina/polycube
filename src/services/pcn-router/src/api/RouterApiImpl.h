...
public:
  ...
  std::string read_router_ports_shadow_by_id(const std::string &name, const std::string &portsName);
  ...
  void update_router_ports_shadow_by_id(const std::string &name, const std::string &portsName, const std::string &value);
