...
// files generated by cmake from "Router_dp_{ingress, egress}.c
#include "Router_dp_ingress.h"
#include "Router_dp_egress.h"
...
Router::Router(const std::string name, const RouterJsonObject &conf, CubeType type)
  : Cube(name, {generate_code()}, {router_code_egress}, type, conf.getPolycubeLoglevel(), conf.getShadow()) {
