...
nlohmann::json RouterJsonObject::helpElements() {
  ...
  val["shadow"]["simpletype"] = "boolean";
  val["shadow"]["description"] = R"POLYCUBE(Defines if the service has the interfaces visible in Linux)POLYCUBE";
  val["shadow"]["example"] = R"POLYCUBE()POLYCUBE";
